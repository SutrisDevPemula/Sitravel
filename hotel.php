...
<?php
$hotel = query("SELECT * FROM tb_hotel");
?>
...
?>
    ...
    <div class="container-fluid" style="margin-top: 200px">
        ...
        <!--    </center>-->
        <br>
        <p style="text-align: center">Kami bekerja sama dengan berbagai jaringan hotel terbaik di seluruh indonesia
            untuk memastikan kenyamanan dan
            pengalaman yang menarik <br> untuk Anda saat menginap!</p><br>
        <div class="row">
            <?php foreach ($hotel as $rows) : ?>
                <div class="col-lg">
                    <div class="card" style="width: 26rem; margin-bottom: 50px">
                        <img src="asset/Upload/Hotel/<?= $rows["gambar"]; ?>" class="card-img-top" alt="..." style="height: 250px">
                        <div class="card-body" style="height: 100px">
                            <h5 class="card-title"><?= $rows["Nama_hotel"]; ?></h5>
                            <p>
                            <img src="asset/icon/lokasi.png" alt="" style="width: 25px; height: 25px; margin-right: 10px">
                                <?= $rows["Alamat"]; ?>
                            </p>
                            <div class="btn btn-outline-primary" style="margin-right: 10px">Hotel</div>
                            <?php for ($i = 0; $i < $rows["bintang"]; $i++) { ?>
                                <img src="asset/icon/bintang.png" alt="" style="width: 25px; height: 25px">
                                <!--                            <span class="card-text">--><? //= $rows["bintang"]; ?><!--</span>-->
                            <?php } ?>
                        </div>
                        <div class="card-footer" style="margin-top: 50px">
                            <div class="row">
                                <div class="col-lg" style="text-align: right">
                                    <small style=" color: #424242; margin-right: 10px">Fasilitas :</small><br>
                                    <small style=" color: #424242; margin-right: 10px"><?= $rows['fasilitas']; ?></small>
                                </div>
                            </div>
                        </div>
                    </div>
